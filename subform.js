...
const SubcriptionForm = () =>{
  ...
  const [formData, setFormData] = useState({
    name: '',
    titleName: 'Harry Potter & the half blood prince',
    subcriptionDate:'',
    grade:'',
    Points:'200'
  });
    ...
    axios.post('http://localhost:8000/data', formData)
      ...
      return(
        ...
        <div class="row" style={{marginTop:'30px'}}>
            ...
            {/* <div class="col" ><b>Points</b> <input type="number" placeholder="Points" name="Points" value={formData.Points} onChange={handleChange} required/> </div> */}
