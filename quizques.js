    ...
    <div>
      {currentQuestion < quizData.length ? (
        ...
        <div class="d-flex justify-content-between">
            <div><p style={{color:'white'}}>Question:{quizData[currentQuestion].id}</p></div>
          <div><h6 class="text-center" style={{color:'white'}}>{quizData[currentQuestion].question}</h6></div>
          <div><p style={{color:'white'}}>Score:{score}</p></div>
          </div>
          <div class="d-flex gap-3" style={{color:'white'}}>
          <ol type='A'>
